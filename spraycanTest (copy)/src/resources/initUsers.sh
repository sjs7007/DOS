...
echo
curl -H "Content-Type: application/json" -X POST -d '{"Email" : "Do8Mufasa@gmail.com" , "Name" : "Saravanan","Birthday": "26th July 1994","CurrentCity" : "Gainesville"}' http://localhost:8087/createUser
echo
